...
function isURLReaderArgs(args: unknown): args is URLReaderArgs {
  return (
    typeof args === "object" &&
    args !== null &&
    typeof (args as URLReaderArgs).url === "string"
  );
}
...
async function fetchAndConvertToMarkdown(url: string, timeoutMs: number = 10000): Promise<string> {
